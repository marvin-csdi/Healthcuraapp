...
def static "commonUIPackage.UITools.tryClickElement"(
    	TestObject to	
     , 	int timeOut	
     , 	boolean isStopOnFailure	) {
    (new commonUIPackage.UITools()).tryClickElement(
        	to
         , 	timeOut
         , 	isStopOnFailure)
}
...
def static "commonUIPackage.UITools.GetTextOfElements"(
    	TestObject obj	) {
    (new commonUIPackage.UITools()).GetTextOfElements(
        	obj)
}
...
def static "commonUIPackage.UITools.GetAttributeOfElements"(
    	TestObject obj	
     , 	String attribute	) {
    (new commonUIPackage.UITools()).GetAttributeOfElements(
        	obj
         , 	attribute)
}
...
def static "com.kms.katalon.keyword.codemirror.CodeMirrorKeywords.setText"(
    	String value	) {
    (new com.kms.katalon.keyword.codemirror.CodeMirrorKeywords()).setText(
        	value)
}


def static "com.kms.katalon.keyword.codemirror.CodeMirrorKeywords.getText"() {
    (new com.kms.katalon.keyword.codemirror.CodeMirrorKeywords()).getText()
}


def static "com.kms.katalon.keyword.codemirror.CodeMirrorKeywords.clearText"() {
    (new com.kms.katalon.keyword.codemirror.CodeMirrorKeywords()).clearText()
}
...
def static "com.kms.katalon.JBehaveKeywords.runStoryFiles"(
    	java.util.List<String> relativeFilePaths	) {
    (new com.kms.katalon.JBehaveKeywords()).runStoryFiles(
        	relativeFilePaths)
}
